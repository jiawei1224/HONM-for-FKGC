...
def get_params():
    ...
    args.add_argument("-seed", "--seed", default=2022, type=int) #None 2022
    ...
    args.add_argument("-max2_neighbor", "--max2_neighbor", default=5, type=int)
    args.add_argument("-lstm_dim", "--lstm_hiddendim", default=800, type=int) #600
